...
public class OverrideHttpMethodRequestParamFilter extends HiddenHttpMethodFilter implements Ordered {
    ...
    public void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws IOException, ServletException {
        ...
        if("POST".equals(request.getMethod()) && StringUtils.hasLength(paramValue)) {
            ...
            OverrideHttpMethodRequestParamFilter.HttpMethodRequestWrapper wrapper = new OverrideHttpMethodRequestParamFilter.HttpMethodRequestWrapper(request, method);
