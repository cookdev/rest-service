...
image:../../images/api/server_page_archi.png[기존 Web Application의 형태]
...
image:../../images/api/api_server_archi.png[RESTful Webservice API Server]
...
2.Response::
image:../../images/api/curl_response.png[curl response]
...
image:../../images/api/postman_header.png[Postman Header]

2.Request Body::
image:../../images/api/postman_payload.png[Postman RequestBody]
____
.RequestBody Payload
[source, Json]
----
...
3.Response::
image:../../images/api/postman_response.png[Postman Response]
